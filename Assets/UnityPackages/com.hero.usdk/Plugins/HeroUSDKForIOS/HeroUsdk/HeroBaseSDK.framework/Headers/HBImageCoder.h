...
/**
 ...
 @note works for `HBImageCoder`, `HeroProgressiveImageCoder`, `HBAnimatedImageCoder`.
 */
...
/**
 A HeroWebImageContext object which hold the original context options from top-level API. (HeroWebImageContext)
 ...
 See `HeroWebImageContext` for more detailed information.
 */
...
/**
 ...
 For custom coder which introduce new image format, you'd better define a new `HBImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/HeroWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol HeroProgressiveImageCoder <HBImageCoder>
