 ...
 */
@interface HeroWebImagePrefetchToken : NSObject <HBWebImageOperation>
...
/**
 * The options for prefetcher. Defaults to HeroWebImageLowPriority.
 */
@property (nonatomic, assign) HeroWebImageOptions options;

/**
 * The context for prefetcher. Defaults to nil.
 */
@property (nonatomic, copy, nullable) HeroWebImageContext *context;
 ...
 */
- (nullable HeroWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
