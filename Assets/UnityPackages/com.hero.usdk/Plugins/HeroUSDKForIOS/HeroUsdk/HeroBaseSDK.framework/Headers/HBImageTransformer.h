 ...
 */
FOUNDATION_EXPORT NSString * _Nullable HeroTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `SDThumbnailedKeyForKey` firstly and then with `HeroTransformedKeyForKey`.`
 */
...
/**
 ...
 You can provide transformer to cache and manager (Through the `transformer` property or context option `HeroWebImageContextImageTransformer`).
